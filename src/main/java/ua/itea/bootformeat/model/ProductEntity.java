package ua.itea.bootformeat.model;
...
@Entity
@Table(name = "products")
@NamedQuery(name = "ProductEntity.getProductsByCategory", query = "SELECT pe FROM ProductEntity pe JOIN Product2category p2c ON " +
